...
public class ERPddmx {
    ...
    public String getXfactprice() {
        return xfactprice;
    }

    public void setXfactprice(String xfactprice) {
        this.xfactprice = xfactprice;
    }
    ...
    public void setFhdd(String fhdd) {
        this.fhdd = fhdd;
    }
