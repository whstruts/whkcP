...
public interface KhzlMapper {
    ...
    @Update("update powererp_hnhryy.jk_hy_yp set gwbh = 'HY2HNHY'||ypbh where gwbh is null and cddm is not null")
    public void updateGWBH();

    @Update("update powererp_hnhryy.jk_hy_yp set gwbh = ypbh where gwbh is null and cddm is null")
